...
export class GithubSvg {
	...
	static renderSvg(stats: TotalStats, pushRow: D1PushRow | null): string {
		...
		// Define Sparklines for reuse with correct dimensions for 360x75 card
		const blueSparkline = `<path d="M 180 65 Q 210 35, 240 50 T 300 40 T 340 30 L 340 70 L 180 70 Z" fill="url(#spark-blue-grad)" />
    ...
    <circle cx="340" cy="30" r="3" fill="#58a6ff" />`;
		...
		const greenSparkline = `<path d="M 180 45 Q 210 42, 240 45 T 300 41 T 340 43 L 340 70 L 180 70 Z" fill="url(#spark-green-grad)" />
