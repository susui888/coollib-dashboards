...
export class AndroidAnalyticsSvg {
	 ...
	 * optimized for GitHub README data injection.
	 ...
	 */
	static renderSvg(metrics: AndroidAnalyticsMetrics, displayDate: string): string {
		...
		const statusText = isDegraded ? "ANDROID INSTANCE DEGRADED" : "ANDROID SYSTEM OPERATIONAL";
		...
		const throughputSparkline = `<path d="M 180 65 Q 210 35, 240 50 T 300 40 T 340 30 L 340 70 L 180 70 Z" fill="url(#spark-blue-grad)" />
    ...
    <circle cx="340" cy="30" r="3" fill="#58a6ff" />`;
		...
		const funnelSparkline = `<path d="M 180 45 Q 210 42, 240 45 T 300 41 T 340 43 L 340 70 L 180 70 Z" fill="url(#spark-green-grad)" />
